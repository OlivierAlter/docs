...
<Card title="Choose Your Model" icon="brain" href="/guides/choosing-generative-model">
  Select the best AI model for your needs.
</Card>

<Card title="The Hub" icon="window-maximize" href="/guides/alter-window">
  Learn about the main Alter workspace interface.
</Card>
