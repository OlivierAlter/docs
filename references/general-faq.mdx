...
- Vision-capable models (for example Gemini, Claude, GPT-4o, Pixtral)
...
Yes. Alter supports Ollama and LM Studio for local processing. See [Privacy-Focused Local Model Workflow](/use-cases/local-model-privacy).
